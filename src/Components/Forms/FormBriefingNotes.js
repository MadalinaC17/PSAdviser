  ...
  return (
    ...
    <div class="card">
      ...
      <div class="card-header">
        INSTRUCTIONS GIVEN BY CLIENT- INVESTIGATION SO FAR
      </div>
      <div class="card-body">
        <form>
          <div class="form-group">
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_23">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_24">
                  No
                </label>
              </div>
            </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_25">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_26">
                  No
                </label>
              </div>
            </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_27">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_28">
                  No
                </label>
              </div>
            </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_29">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_30">
                  No
                </label>
              </div>
            </div>
      ...
      <div class="card-body">
        <form>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_31">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_32">
                  No
                </label>
              </div>
            </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_33">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_34">
                  No
                </label>
              </div>
            </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_35">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_36">
                  No
                </label>
              </div>
            </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_38">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_39">
                  No
                </label>
              </div>
            </div>
          ...
          <div class="form-group">
            <label for="input_id_30">
              If the answer to any of the above is ‘yes’, give details here
            </label>
            <input
              type="text"
              class="form-control"
      ...
      <div class="card-body">
        <form>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_40">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_41">
                  N/A
                </label>
              </div>
            </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_42">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_43">
                  N/A
                </label>
              </div>
            </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_44">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_45">
                  N/A
                </label>
              </div>
            </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_46">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_47">
                  N/A
                </label>
              </div>
            </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_48">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_49">
                  N/A
                </label>
              </div>
            </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_50">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_51">
                  N/A
                </label>
              </div>
            </div>
          ...
          <div class="form-group">
            <label for="input_id_35">
              ADVICE GIVEN - IDENTIFICATION ISSUES
            </label>
          </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_52">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_53">
                  No
                </label>
              </div>
            </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_54">
                  N/A
                </label>
              </div>
            </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_55">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_56">
                  No
                </label>
              </div>
            </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_57">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_58">
                  No
                </label>
              </div>
            </div>
            ...
            <div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="1"
                />
                <label class="custom-control-label" for="ic_id_500">
                  Yes
                </label>
              </div>
              <div class="custom-control custom-switch custom-control-inline">
                <input
                  ...
                  value="2"
                />
                <label class="custom-control-label" for="ic_id_502">
                  No
                </label>
              </div>
            </div>
          ...
          <div class="form-group">
            <label for="input_id_38">
              Is The Client To Face Further Action
            </label>
            <input
              type="text"
              class="form-control"
